    ...
    try:
        ...
        if not os.path.exists(template_path):
            ...
            <head>
                ...
                <title>Bot Telegram Trích Xuất Link Phim</title>
                <style>
            ...
            <body>
                <div class="container">
                    <h1>Bot Telegram Trích Xuất Link Phim</h1>
                    <div class="status">
                        <h3>Trạng thái: Bot đang hoạt động</h3>
                        <p>Bot Telegram đã được khởi động thành công và sẵn sàng nhận tin nhắn.</p>
                        <p>Để sử dụng bot, hãy tìm bot trên Telegram và gửi link trang phim để trích xuất link streaming.</p>
                    </div>
                </div>
            </body>
            </html>
        ...
        return Response(text="<h1>Bot Telegram đang hoạt động</h1>", content_type='text/html')
