...
def is_supported_domain(url: str) -> bool:
    ...
    try:
        ...
        # For testing purposes, allow the domains from user messages
        logger.info(f"Domain '{domain}' not in supported list, but allowing for extraction attempt")
        return True  # Allow all domains for now to test functionality
